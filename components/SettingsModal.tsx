...
import { X, User, Settings2, Key, ChevronDown, Zap, ShieldCheck, CheckCircle2, AlertTriangle, Loader2, Cpu } from 'lucide-react';
        ...
        <div className="flex items-center justify-between px-8 py-6 border-b border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-[#282a2c]">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400 uppercase font-black tracking-widest mt-0.5">Gerenciamento de Identidade e APIs</p>
            </div>
          </div>
